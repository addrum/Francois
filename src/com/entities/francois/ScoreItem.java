...
public class ScoreItem implements Entity {
	...
	public ScoreItem(Bitmap bitmap, int spawnX, int y) {
		ScoreItem.bitmap = bitmap;
		this.x = spawnX;
		this.y = y;
		this.yv = 25;
